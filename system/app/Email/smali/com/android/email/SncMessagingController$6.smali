.class Lcom/android/email/SncMessagingController$6;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/email/SncMessagingController;->qreSyncMailbox(Lcom/android/emailcommon/provider/EmailContent$Account;Lcom/android/emailcommon/provider/EmailContent$Mailbox;)V
.end annotation
...
.method constructor <init>(Lcom/android/email/SncMessagingController;Lcom/android/emailcommon/provider/EmailContent$Mailbox;Lcom/android/emailcommon/provider/EmailContent$Account;)V
    ...
    .prologue
    .line 623
    iput-object p1, p0, Lcom/android/email/SncMessagingController$6;->this$0:Lcom/android/email/SncMessagingController;

    iput-object p2, p0, Lcom/android/email/SncMessagingController$6;->val$folder:Lcom/android/emailcommon/provider/EmailContent$Mailbox;

    iput-object p3, p0, Lcom/android/email/SncMessagingController$6;->val$account:Lcom/android/emailcommon/provider/EmailContent$Account;
...
.method public run()V
    ...
    .line 625
    iget-object v0, p0, Lcom/android/email/SncMessagingController$6;->this$0:Lcom/android/email/SncMessagingController;

    iget-object v1, p0, Lcom/android/email/SncMessagingController$6;->val$folder:Lcom/android/emailcommon/provider/EmailContent$Mailbox;
    ...
    iget-object v1, p0, Lcom/android/email/SncMessagingController$6;->val$account:Lcom/android/emailcommon/provider/EmailContent$Account;

    iget-object v2, p0, Lcom/android/email/SncMessagingController$6;->val$folder:Lcom/android/emailcommon/provider/EmailContent$Mailbox;
    ...
    .line 627
    iget-object v0, p0, Lcom/android/email/SncMessagingController$6;->val$folder:Lcom/android/emailcommon/provider/EmailContent$Mailbox;
    ...
    const-string v2, "Invoking the service callback hack for accId - "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p0, Lcom/android/email/SncMessagingController$6;->val$account:Lcom/android/emailcommon/provider/EmailContent$Account;
    ...
    iget-object v3, p0, Lcom/android/email/SncMessagingController$6;->val$folder:Lcom/android/emailcommon/provider/EmailContent$Mailbox;

    iget-wide v3, v3, Lcom/android/emailcommon/provider/EmailContent;->mId:J

    const/16 v6, 0x64

    iget-object v7, p0, Lcom/android/email/SncMessagingController$6;->val$folder:Lcom/android/emailcommon/provider/EmailContent$Mailbox;
    ...
    .line 635
    :cond_0
    iget-object v0, p0, Lcom/android/email/SncMessagingController$6;->val$account:Lcom/android/emailcommon/provider/EmailContent$Account;
